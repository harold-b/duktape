/*
 *  Test duk_put_prop_list() and initializers.
 */
...
static duk_ret_t test_types(duk_context *ctx) {
	...
	duk_prop_list_entry props[] = {
		...
		DUK_PROP_LIGHTFUNC("lightfuncValue", my_function, 4 /*nargs*/, 2 /*length*/, 9 /*magic*/),
	...
	duk_eval_string(ctx,
		...
		"    v.lightfuncValue('foo', 'bar', 'quux', 'baz', 'quuux');\n"
...
/* Test a deeply nested structure.  This ensures that duk_put_prop_list() does
